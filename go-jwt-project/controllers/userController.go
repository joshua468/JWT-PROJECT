...
import (
	...
	"github.com/joshua468/go-jwt-project/models"
...
func Signup() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		if err != nil {
			log.Panic(err)
			c.JSON(http.StatusInternalServerError, gin.H{"error": "error occurred while checking for the phone numbers"})
			return
		}
...
func GetUsers() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		// The pipeline should be a slice
		pipeline := mongo.Pipeline{matchStage, groupStage, projectStage}

		// Use Aggregate instead of AggregateAll
